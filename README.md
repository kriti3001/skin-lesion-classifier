...
# !\[Confusion Matrix](models/confusion\_matrix\_resnet.png)
...
# !\[Melanoma prediction example](assets/melanoma\_prediction\_example.png)
...
# You will need the trained model file, models/best\_model\_resnet.keras, which is tracked using Git LFS in this repo.
...
# python src/evaluate.py --model models/best\_model\_resnet.keras --suffix resnet
...
# &#x20;       export\_demo\_images.py

# &#x20;       find\_good\_demo\_examples.py
